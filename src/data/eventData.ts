...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer: 'ניסיון של מעל 15 שנה ו-850 אירועים, בליווי צוות ניהול ייעודי בשטח המבטיח זרימה מושלמת.'
  },
  {
    category: 'זמנים',
...
export const STATS = [
  ...
  { value: '850+', label: 'אירועים נבחרים' },
  { value: '100%', label: 'מחויבות לתוצאה' },
  { value: '24/7', label: 'זמינות וליווי' },
];
