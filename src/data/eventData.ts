...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer: 'אנחנו מפיקים אירוע יחיד ביום בלבד, עם נוכחות וליווי אישי של נופר משלב האפיון, דרך ההקמות בבוקר ועד אחרון האורחים בריכוז מלא וללא מפיקי משנה.'
  },
  {
    category: 'זמנים',
  ...
  },
  {
    ...
    answer: 'בפגישות אפיון ממוקדות, עדכונים רציפים ותוכנית עבודה שקופה המעניקה לכם ודאות מלאה ושקט נפשי.'
  },
  {
...
export const STATS = [
  ...
  { value: '100%', label: 'ליווי אישי של נופר', desc: 'ללא מפיקי משנה' },
  { value: '1', label: 'כתובת לכל הספקים', desc: 'סנכרון וניהול מושלם' },
